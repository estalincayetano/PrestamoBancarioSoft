 ...
 * @author estal
 */
public class FormRegistrarPagos extends javax.swing.JDialog {    
    ...
    public FormRegistrarPagos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void mostrarPrestamosCliente() {
        ...
        ConfiguradorDeTabla.configurarAnchoColumna(tablaPrestamos, 0, 35, 45, 35);
        ConfiguradorDeTabla.configurarAnchoColumna(tablaPrestamos, 1, 70, 70, 10);
        ConfiguradorDeTabla.configurarAnchoColumna(tablaPrestamos, 2, 70, 70, 70);
        ConfiguradorDeTabla.configurarAnchoColumna(tablaPrestamos, 3, 90, 90, 90);
        ConfiguradorDeTabla.configurarAnchoColumna(tablaPrestamos, 4, 70, 0, 0);
    }
    ...
    private void initComponents() {
        ...
        txtCajero.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(txtCajero, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRegistrarPagos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormRegistrarPagos dialog = new FormRegistrarPagos(new javax.swing.JFrame(), true);
